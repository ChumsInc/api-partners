...
function fetchGETResults(url, auth) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            const response = yield (0, node_fetch_1.default)(urlParts.toString(), { method: 'GET', headers });
            if (!response.ok) {
...
function fetchPUT(url, data = {}, auth) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            headers.set('Content-Type', 'application/json');
            const body = JSON.stringify(data);
            const response = yield (0, node_fetch_1.default)(url, { method: 'PUT', headers, body });
            if (response.ok) {
