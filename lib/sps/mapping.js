...
async function saveCustomer({ ARDivisionNo, CustomerNo, LookupFields, options }) {
    try {
...
export async function loadCustomerMapping({ ARDivisionNo, CustomerNo }) {
    try {
...
export async function addCustomerMapping({ id, ARDivisionNo, CustomerNo, MapField, CSVField, CustomerValue, MappedValue, MappedOptions }) {
    try {
        id = Number(id) || 0;
...
async function removeCustomerMapping({ ARDivisionNo, CustomerNo, id }) {
    try {
        const query = `DELETE
                               FROM sps_edi.mapping
                               WHERE Company = 'chums'
...
export async function loadBillToAddress({ ARDivisionNo, CustomerNo }) {
    try {
...
export async function loadShipToAddress({ ARDivisionNo, CustomerNo, ShipToCode = '%' }) {
    try {
...
export const getMapping = async (req, res) => {
    try {
        const ARDivisionNo = req.params.ARDivisionNo;
...
export const removeCustomerItem = async (req, res) => {
    try {
        // @todo: implement this
    }
    catch (err) {
