...
exports.deleteItemMap = exports.postItemMap = exports.getItemMap = exports.postGLAccount = exports.postFBAInvoiceCharges = exports.postFBAInvoiceSalesOrder = exports.postFBAInvoiceBaseData = exports.postFBAInvoice = void 0;
const debug_1 = __importDefault(require("debug"));
const parser_1 = require("./parser");
const chums_local_modules_1 = require("chums-local-modules");
const db_handler_1 = require("./db-handler");
const debug = (0, debug_1.default)('chums:lib:amazon:seller-central:fba:index');
...
const postFBAInvoiceBaseData = async (req, res) => {
    try {
        const content = await (0, chums_local_modules_1.expressUploadFile)(req);
        const data = await (0, parser_1.parseTextFile)(content);
        const settlement = await (0, parser_1.parseSettlementBaseData)(data);
        res.json({ settlement });
    }
    catch (err) {
        if (err instanceof Error) {
...
exports.postFBAInvoiceBaseData = postFBAInvoiceBaseData;
const postFBAInvoiceSalesOrder = async (req, res) => {
    try {
        const content = await (0, chums_local_modules_1.expressUploadFile)(req);
        const data = await (0, parser_1.parseTextFile)(content);
        const settlement = await (0, parser_1.parseSettlementSalesOrder)(data);
        res.json({ settlement });
    }
    catch (err) {
        if (err instanceof Error) {
...
exports.postFBAInvoiceSalesOrder = postFBAInvoiceSalesOrder;
const postFBAInvoiceCharges = async (req, res) => {
    try {
        const content = await (0, chums_local_modules_1.expressUploadFile)(req);
        const data = await (0, parser_1.parseTextFile)(content);
        const settlement = await (0, parser_1.parseSettlementCharges)(data);
        res.json({ settlement });
    }
    catch (err) {
        if (err instanceof Error) {
...
exports.postFBAInvoiceCharges = postFBAInvoiceCharges;
