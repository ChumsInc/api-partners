    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            try {
                ...
                fields_1 = header.split('\t').map(function (str) { return (0, camelcase_1["default"])(str.trim()); });
            ...
            switch (_a.label) {
                ...
                case 4:
                    ...
                    rows.filter(function (row) { return row.fulfillmentId === 'AFN'; })
                        ...
                        var key = "".concat(row.fulfillmentId, ":").concat(row.transactionType || '', ":").concat((0, camelcase_1["default"])(row.amountType), ":").concat((0, camelcase_1["default"])(row.amountDescription));
                        if (!charges_1[key]) {
                    ...
                    rows.filter(function (row) { return row.transactionType !== 'Order' && row.transactionType !== 'Refund'; })
                        ...
                        var key = "".concat(row.fulfillmentId, ":").concat((0, camelcase_1["default"])(row.amountType), ":").concat((0, camelcase_1["default"])(row.amountDescription));
                        if (!charges_1[key]) {
