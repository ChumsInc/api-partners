...
const product_feed_1 = require("./product-feed");
...
router.get('/products', products_1.getAvailable);
router.post('/product', products_1.postProduct);
router.get('/product/pricing/:SKU', products_1.getProductCompetitivePricing);
router.get('/product/:ASIN', products_1.getProduct);
router.get('/product-feed', product_feed_1.postFeed);
router.post('/product-feed', product_feed_1.postFeed);
